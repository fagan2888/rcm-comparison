...
rsTXT = [Op.Optim_Method,':TRAIN:',OptimizeConstant.getHessianApprox(Op.Hessian_approx),':',sprintf('(%f)', Op.value),sprintf(':(%f):', norm(Op.grad)),sprintf('%d\n', Op.nFev)];
